...
- **word_counter.sh** - подсчитывает слова по определению из задания
...
Использование **скрипта text_processor.sh**, который объединяет все функции в одном файле:
...
## Примеры использования итогового скрипта:
...
Да, можно реализовать на bash с использованием `grep` и регулярных выражений. Вот несколько вариантов:

## Вариант 1: скрипт email_extractor
...
## Вариант 2: Более компактная версия
